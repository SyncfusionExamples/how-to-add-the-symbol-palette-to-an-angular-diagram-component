...
A quick start Angular project that shows how to add and customize the symbol palette using the [Angular Diagram](https://www.syncfusion.com/angular-components/angular-diagram) component. This project also includes a code snippet to restrict the symbol palette's panel and customize its symbol size and symbol preview size.
